...
public class LiveTest {
    ...
    private static class AuthenticationOK implements RealJenkinsRule.Step {
        ...
        public void run(JenkinsRule r) throws Throwable {
            SamlSecurityRealm realm = configureBasicSettings(new IdpMetadataConfiguration(idpMetadata), new SamlAdvancedConfiguration(false, null, SERVICE_PROVIDER_ID, null, /* TODO maximumSessionLifetime unused */null, true, null, false, null, null, null, null, null, null, null, null, null ), new SamlLdapLookUp(null, false, null, null, null, null, null, null, null, null, null), SAML2_REDIRECT_BINDING_URI);
    ...
    private static class AuthenticationOKFromURL implements RealJenkinsRule.Step {
        ...
        @Override
        public void run(JenkinsRule r) throws Throwable {
            SamlSecurityRealm realm = configureBasicSettings(new IdpMetadataConfiguration(idpMetadataUrl, 0L), new SamlAdvancedConfiguration(false, null, SERVICE_PROVIDER_ID, null, null, true, null, false, null, null, null, null, null, null, null, null, null), new SamlLdapLookUp(null, false, null, null, null, null, null, null, null, null, null), SAML2_REDIRECT_BINDING_URI);
    ...
    private static class AuthenticationOKPostBinding implements RealJenkinsRule.Step {
        ...
        @Override
        public void run(JenkinsRule r) throws Throwable {
            SamlSecurityRealm realm = configureBasicSettings(new IdpMetadataConfiguration(idpMetadata), new SamlAdvancedConfiguration(false, null, SERVICE_PROVIDER_ID, null, null, true, null, false, null, null, null, null, null, null, null, null, null), new SamlLdapLookUp(null, false, null, null, null, null, null, null, null, null, null), SAML2_POST_BINDING_URI);
            r.jenkins.setSecurityRealm(realm);
            configureAuthorization();
            makeLoginWithUser1(r);
        }
    ...
    private static class AuthenticationFail implements RealJenkinsRule.Step {
        ...
        @Override
        public void run(JenkinsRule r) throws Throwable {
            SamlSecurityRealm realm = configureBasicSettings(new IdpMetadataConfiguration(idpMetadata), new SamlAdvancedConfiguration(false, null, SERVICE_PROVIDER_ID, null, null, true, null, false, null, null, null, null, null, null, null, null, null), new SamlLdapLookUp(null, false, null, null, null, null, null, null, null, null, null), SAML2_REDIRECT_BINDING_URI);
            r.jenkins.setSecurityRealm(realm);
            configureAuthorization();
    ...
    private static SamlSecurityRealm configureBasicSettings(IdpMetadataConfiguration idpMetadataConfiguration, SamlAdvancedConfiguration advancedConfiguration, SamlLdapLookUp ldapUserLookUp, String binding) throws IOException {
        ...
        return new SamlSecurityRealm(idpMetadataConfiguration, "displayName", "eduPersonAffiliation", 86400, "uid", "email", null, advancedConfiguration, samlEncryptionData, ldapUserLookUp, "none", binding, Collections.emptyList());
    }
