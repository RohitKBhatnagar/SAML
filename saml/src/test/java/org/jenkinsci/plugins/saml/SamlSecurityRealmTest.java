...
public class SamlSecurityRealmTest {
    ...
    public void testGetters() throws IOException {
        SamlPluginConfig samlPluginConfig = new SamlPluginConfig(samlSecurityRealm.getDisplayNameAttributeName(),
                ...
                samlSecurityRealm.getLdapLookUp());
        assertEquals(samlPluginConfig.toString().equals(samlSecurityRealm.getSamlPluginConfig().toString()), true);

        assertEquals(new SamlAdvancedConfiguration(null,null,null, null, null, true, null, false, null, null, null, null, null, null, null, null, null).toString().contains("SamlAdvancedConfiguration"),true);
        assertEquals(new SamlAdvancedConfiguration(true,null,null, null, null, true, null, false, null, null, null, null, null, null, null, null, null).toString().contains("SamlAdvancedConfiguration"),true);
        assertEquals(new SamlAdvancedConfiguration(true,"","", "", 1, true, "", false, "", "", "", "", "", "", null, "", "").toString().contains("SamlAdvancedConfiguration"),true);
